...
<html lang="pt-br">
    <head>
        ...
        <title>MB Fashion - Cadastrar Tamanho</title>
                    ...
                    <form action="gerenciar_tamanho.do" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-8">
                                ...
                                <input type="text" name="nome" id="nome" value="${t.nome}" class="form-control" required="" maxlength="45"/>
                            </div>
                        </div>
                        <button class="btn btn-info">Gravar</button>
                        <a href="listar_tamanho.jsp" class="btn btn-danger">Voltar</a>
                    </form>
                </div>
            </div>
        </main>
