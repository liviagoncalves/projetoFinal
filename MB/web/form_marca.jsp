...
<html lang="pt-br">
    <head>
        ...
        <title>MB Fashion - Cadastrar Marca</title>
                    ...
                    <form action="gerenciar_marca.do" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-8">
                                ...
                                <input type="text" name="nome" id="nome" value="${m.nome}" class="form-control" required="" maxlength="45"/>
                            </div>
                        </div>
                        <button class="btn btn-info">Gravar</button>
                        <a href="listar_marca.jsp" class="btn btn-danger">Voltar</a>
                    </form>
                </div>
            </div>
        </main>
